...
Inflector::rules('uninflected', ['users']);
Inflector::rules('uninflected', ['profs']);
Inflector::rules('uninflected', ['parieurs']);
Inflector::rules('uninflected', ['paris']);
Inflector::rules('uninflected', ['pariscombine']);
Inflector::rules('uninflected', ['combine']);
Inflector::rules('uninflected', ['historique']);
